...
@section('content')
    ...
    <div class="page-content">
        <form class="row ajax-form" method="post" action="{{ route('admin.banners.store') }}">
            @csrf
            ...
            @foreach($locales as $locale)
                <div class="col-md-6 col-sm-6 form-group">
                    ...
                    <input class="form-control" type="text" name="header_{{ $locale }}" required>
                </div>
                <div class="col-md-6 col-sm-6 form-group">
                    <label>Subtitle ({{ strtoupper($locale) }})</label>
                    <input class="form-control" name="subtitle_{{ $locale }}" required>
                </div>
            @endforeach
            <div class="col-md-12 col-sm-12 form-group">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:;" class="icon-btn red-bc delete-btn"
                                    data-url="{{ route('admin.banners.destroy', ['banner' => $banner->id]) }}">
